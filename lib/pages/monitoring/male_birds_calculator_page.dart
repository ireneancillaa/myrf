...
class MaleBirdsCalculatorPage extends StatefulWidget {
  const MaleBirdsCalculatorPage({
    super.key,
    this.stageTitle = 'Male Birds',
    this.stageGroup = '',
    this.stageRange = '',
    this.initialDate = '',
  ...
  @override
  State<MaleBirdsCalculatorPage> createState() => _MaleBirdsCalculatorPageState();
}

class _MaleBirdsCalculatorPageState extends State<MaleBirdsCalculatorPage> {
